...
void movimientoJugador(float X_jugador, float Y_jugador)
{
...
int main(int argc, char **argv)
{
	...
	Jugador = al_create_bitmap(JUGADOR_SIZE, JUGADOR_SIZE);
	if (!Jugador) {
	...
	while (!gameOver)
	{
		...
		if (redraw && al_is_event_queue_empty(event_queue)) {
			...
			draw(Jugador, Jugador_x, Jugador_y, 0);
